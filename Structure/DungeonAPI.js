...
var Dungeon = {
    ...
    getBlockID: function(id){
        let Block = FileTools.ReadJSON(__packdir__ + "innercore/mods/.staticids").id.blocks[id];
        if(!Block){
            Block = parseInt(id);
        }
        return Block;
    ...
    isBlock: function(id){
        let blocks = FileTools.ReadJSON(__packdir__ + "innercore/mods/.staticids").id.blocks;
        let d;
        if(id >= 8000){
